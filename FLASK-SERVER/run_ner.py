...
def ner_main():
    ...
    print("[*] ner_main() Arguments", type(args), args)
...
if __name__ == "__main__":
    # python run_ner.py --data_dir=ner_data/ --bert_model=bert-base-cased --task_name=ner --output_dir=out_base --max_seq_length=128 --do_train --num_train_epochs 5 --do_eval --warmup_proportion=0.1
    ner_main()
